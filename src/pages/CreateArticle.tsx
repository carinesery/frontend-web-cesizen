...
import { z } from 'zod';
import { createArticleBodySchema } from '../schemas/articleSchema';
import { categoryService } from '../services/categoryService';
import { articleService } from '../services/articleService';
import AdminLayout from '../components/AdminLayout';
import { formStyles, getInputStyle, getTextareaStyle, getSelectStyle, getFileInputStyle } from '../styles/formStyles';
...
const CreateArticle = () => {
  ...
  const validateField = (name, value) => {
    try {
      ...
      const fieldSchema = (createArticleBodySchema as any).pick({ [name]: true });
    ...
    <AdminLayout>
      <div style={{ ...formStyles.container, maxWidth: 'none' }}>
        <div style={formStyles.formHeader}>
          <h2 style={formStyles.formTitle}>Créer un nouvel article</h2>
          <button
            type="button"
